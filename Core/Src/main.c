...
/* USER CODE END MX_GPIO_Init_1 */
  ...
  HAL_GPIO_WritePin(GPIOB, GPIO_PIN_0|GPIO_PIN_1|GPIO_PIN_2|GPIO_PIN_10
                          |GPIO_PIN_11|SHCP_Pin|STCP_Pin|DS_Pin
  ...
  /*Configure GPIO pins : S2_Pin S4_Pin */
  GPIO_InitStruct.Pin = S2_Pin|S4_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_EVT_FALLING;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  HAL_GPIO_Init(GPIOA, &GPIO_InitStruct);
	
	 LL_AHB1_GRP1_EnableClock(LL_AHB1_GRP1_PERIPH_GPIOA);  // Enable the GPIOA clock
    LL_GPIO_SetPinMode(GPIOA, LL_GPIO_PIN_0, LL_GPIO_MODE_OUTPUT);  // Configure GPIOA pin 5 as output
    LL_GPIO_ResetOutputPin(GPIOA, LL_GPIO_PIN_0);  // Make sure the pin starts low
